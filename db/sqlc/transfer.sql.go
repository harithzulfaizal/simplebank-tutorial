...
func (q *Queries) GetTransferByFromAccountID(ctx context.Context, arg GetTransferByFromAccountIDParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, getTransferByFromAccountID, arg.FromAccountID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetTransferByToAccountID(ctx context.Context, arg GetTransferByToAccountIDParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, getTransferByToAccountID, arg.ToAccountID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
